...
Original file is located at
    https://colab.research.google.com/drive/10zbKlI-YKXlX7oTIcwwIFba4iuvXOIyR
"""
...
# Draw  square
def draw_square(x, y, size):    #############Problem
    half_size = size // 2
...
def showScreen():
    ...
    if not game_over:
        # Draw the snake
        #add_color(114, 124, 27)  # Snake Color
        glColor4f(1.0, 1.0, 1.0, 0.0)  # Snake Color = White
        glBegin(GL_POINTS)
        draw_snake(snake)
        glEnd()
...
def main():
    glutInit()
    glutInitDisplayMode(GLUT_RGBA)  # GLUT_RGBA = window have color buffer with red, green, blue and alpha channels
    glutInitWindowSize(500, 500)  # Window size
    glutInitWindowPosition(500, 100)  # Window postion
    wind = glutCreateWindow(b"Snake Game")  # Window name, b = byte object
